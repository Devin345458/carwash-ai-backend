...
class InventoryTransactionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'transaction_action_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'quantity' => 1,
                'difference' => 1,
                'created' => '2019-05-28 19:44:35',
                'created_by' => '58082fd0-77ca-407f-a246-b6ccb97e37cb',
