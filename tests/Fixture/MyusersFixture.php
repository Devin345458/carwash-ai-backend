...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'company_user_fbk1' => ['type' => 'foreign', 'columns' => ['company_id'], 'references' => ['companys', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => '9d45d83d-5717-463f-81f1-ea15654c3b65',
                ...
                'token_expires' => '2018-07-08 21:03:55',
                'api_token' => 'Lorem ipsum dolor sit amet',
                'activation_date' => '2018-07-08 21:03:55',
                'secret' => 'Lorem ipsum dolor sit amet',
                'secret_verified' => 1,
                'tos_date' => '2018-07-08 21:03:55',
                'active' => 1,
                'is_superuser' => 1,
                'role' => 'Lorem ipsum dolor sit amet',
                'company_id' => 1,
                'created' => '2018-07-08 21:03:55',
                'modified' => '2018-07-08 21:03:55',
            ],
        ];
        parent::init();
    }
