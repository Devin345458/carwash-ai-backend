...
class StoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'photo' => ['type' => 'upload.file', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'companys_id' => ['type' => 'index', 'columns' => ['company_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'company_fbk' => ['type' => 'foreign', 'columns' => ['company_id'], 'references' => ['companys', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'number' => 1,
                'created' => '2018-07-09 01:54:30',
                'modified' => '2018-07-09 01:54:30',
                'photo' => '',
