...
class SubtasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'repairs_subtaks' => ['type' => 'foreign', 'columns' => ['repair_id'], 'references' => ['subtasks', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-08 19:18:59',
                'modified' => '2018-07-08 19:18:59',
                'repair_id' => 1,
            ],
        ];
        parent::init();
