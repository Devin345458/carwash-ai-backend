...
class StepsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'steps_order' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'maintenance_step_fbk' => ['type' => 'foreign', 'columns' => ['maintenance_id'], 'references' => ['maintenances', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'steps_order' => 1,
                'created' => '2018-07-08 19:18:09',
                'modified' => '2018-07-08 19:18:09',
                'maintenance_id' => 1,
            ],
        ];
        parent::init();
