...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'cba30f93df41f07d894b0d2f9a79cecd1050f3703ab9e6a50317d8aaae8b53fa'),
    ],
    ...
    'Error' => [
        'errorLevel' => E_ERROR,
        'exceptionRenderer' => 'App\Error\JsonApiExceptionRenderer',
        'log' => true,
        'skipLog' =>  ['Cake\Network\Exception\NotFoundException', 'Cake\Network\Exception\UnauthorizedException'],
        'trace' => true,
    ],
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'port' => 587,
            'timeout' => 60,
            'username' => 'd502f986c29ee1c4d4d63fff732db21b',
            'password' => '5bc344765bbc17e0f11c89e740dccbbc',
            'className' => 'Smtp',
        ],
    ],
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => ['sales@carwashai.com' => 'Car Wash Ai'],
            'charset' => 'utf-8',
            'headerCharset' => 'utf-8',
        ],
    ],
